...
class EvaluateRetrieval:
    ...
    def consistent_retrieve(self, corpus: Dict[str, Dict[str, str]], queries: Dict[str, str], **kwargs) -> Dict[str, Dict[str, float]]:
        if not self.retriever:
            raise ValueError("Model/Technique has not been provided!")
        return self.retriever.consistent_search(corpus, queries, self.top_k, self.score_function, **kwargs)
