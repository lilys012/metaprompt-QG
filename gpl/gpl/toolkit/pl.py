...
class PseudoLabeler(object):
    def __init__(
        ...
        assert qgen_prefix+"-hard-negatives.jsonl" in os.listdir(generated_path)
        fpath_hard_negatives = os.path.join(generated_path, qgen_prefix+"-hard-negatives.jsonl")
        ...
        self.output_path = os.path.join(generated_path, qgen_prefix+"-gpl-training-data.tsv")
